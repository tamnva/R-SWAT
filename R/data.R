#' Example SWAT and SWAT+ data files
#'
...
#'
#' @seealso \code{\link{extracExampleData}} for extracting (save to files) these example data
#'
#' @docType data
#'
#' @author Tam V. Nguyen \email{tam.nguyen@ufz.de}
#'
