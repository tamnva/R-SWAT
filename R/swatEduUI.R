...
swatEduUI <- function(id) {
  ...
  tagList(
    ...
    fluidRow(
      ...
      column(width = 12,
             checkboxInput('checkBoxHelp', 'Show User guide', value = FALSE, width = NULL),
      ),
      ...
      conditionalPanel(
        ...
        column(12,
               box(width = NULL,
                   ...
                   solidHeader = TRUE,
                   collapsible = TRUE,
                   includeHTML("HTML/manualCalibration.html")
               )),
      ),
      ...
      column(6,
             ...
             lapply(1:10, function(i) {
               plotlyOutput(paste0('SwatEduPlot', i), height = "250px")
             }
             )),
