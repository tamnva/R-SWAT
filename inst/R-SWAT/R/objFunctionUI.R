...
objFunctionUI <- function(id) {
  ...
  tagList(
    ...
    fluidRow(
      ...
      column(width = 1,
             tippy::tippy("Help", tooltip = "<span style='font-size:16px;'>
      ...
      conditionalPanel(
        ...
        column(width = 10,
               actionButton("getUserObjFunction",
                            "Load userObjFunction.R",
                            buttonType = "default",
        ...
        # Display file name
        column(width = 10,
               verbatimTextOutput("userObjFunctionFile", placeholder = TRUE),
        ),
      ),
      ...
      column(width = 10,
             conditionalPanel(
               ...
               shinyFiles::shinyFilesButton("getObservedDataFile", "Click here to select" ,
      ...
      conditionalPanel(
        ...
        column(width = 10,
               plotly::plotlyOutput("plotObjFunction", height = "500px"),
        ),
